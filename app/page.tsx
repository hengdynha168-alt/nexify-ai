...
return ( <main className="min-h-screen bg-[#0B0F19] text-white px-6 py-12"> <div className="max-w-5xl mx-auto"> <h1 className="text-7xl font-extrabold text-center mb-4 bg-gradient-to-r from-green-400 via-emerald-500 to-teal-400 bg-clip-text text-transparent">
Nexify AI </h1>
...
Score: ${clip.score}`
            ...
            className="mt-4 px-4 py-2 rounded-xl bg-green-600 hover:bg-green-500"
          >
            Copy
          </button>
        </div>
